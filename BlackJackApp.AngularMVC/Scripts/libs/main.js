...
/* harmony import */ var _progress_kendo_angular_inputs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @progress/kendo-angular-inputs */ "./node_modules/@progress/kendo-angular-inputs/dist/es/index.js");
...
/* harmony import */ var _app_start_game_start_game_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../app/start-game/start-game.component */ "./src/app/start-game/start-game.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _app_start_game_start_game_component__WEBPACK_IMPORTED_MODULE_7__["StartGame"]
            ],
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                _progress_kendo_angular_buttons__WEBPACK_IMPORTED_MODULE_2__["ButtonsModule"],
                _progress_kendo_angular_inputs__WEBPACK_IMPORTED_MODULE_3__["InputsModule"],
...
/*!****************************************************!*\
  !*** ./src/app/start-game/start-game.component.ts ***!
  \****************************************************/
/*! exports provided: StartGame, StartGameView, GameService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var StartGame = /** @class */ (function () {
    function StartGame(gameService) {
        this.gameService = gameService;
        this.title = 'here the game is started';
        this.listItems = [0, 1, 2, 3, 4, 5];
        this.model = new StartGameView();
    }
    StartGame.prototype.ngOnInit = function () {
        var _this = this;
        this.gameService.getUsers().sunscribe(function (result) {
            _this.model.users = result;
        });
    };
    StartGame.prototype.onButtonClick = function () {
        var _this = this;
        this.title = 'Hello from Kendo UI!';
        this.gameService.createGame(this.model).subscribe(function (result) {
